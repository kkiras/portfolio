...
import timeline from "../../datas/timeline";
...
export default function Timeline() {
    ...
    // const timeline = [
    //     {id: 1, type: "education", year: 2020, description: "Trúng tuyển và học Tài chính - Ngân hàng tại ĐH Quốc Tế thuộc Đại Học Quốc Gia", detail: "Được định hướng ngành Tài chính Ngân hàng khi thi tuyển sinh, sau đó đạt được nguyện vọng tham gia học tập tại Đại Học Quốc Tế.", picture: "/src/assets/experience/iu.jpg"},
    //     {id: 2, type: "education", year: 2021, description: "Học Kỹ Thuật Phần Mềm tại Đại Học Văn Lang", detail: "Sau 1 năm theo học Đại Học Quốc Tế, quyết định chuyển sang ngành Kỹ Thuật Phần Mềm tại Đại Học Văn Lang để theo đuổi đam mê lập trình.", picture: "/src/assets/experience/vlu.jpg"},
    //     {id: 3, type: "experience", year: 2025, description: "Thực tập tại ngân hàng Quân Đội với vai trò Business Analyst", detail: "Có cơ hội thực tập tại Ngân hàng Quân đội để nghiên cứu, phân tích về nghiệp vụ ngân hàng. Tạo tiền đề cho công việc Business Analyst.", picture: "/src/assets/experience/mbbank.jpg"},
    //     {id: 4, type: "education", year: 2025, description: "Bảo vệ khóa luận tốt nghiệp tại Đại Học Văn Lang", detail: "skfhklahekjsadnjfbkalshdfksabklghsadkfj", picture: "/src/assets/experience/vlu_bvda.jpg"},
    //     {id: 5, type: "education", year: 2026, description: "Tốt nghiệp cử nhân ngành Kỹ Thuật Phần Mềm tại Đại Học Văn Lang", detail: "Sau nhiều năm học tập và nghiên cứu ngành Kỹ Thuật Phần Mềm tại Đại Học Văn Lang, tốt nghiệp loại Khá cùng nhiều kinh nghiệm thực hành trong quá trình học tập ", picture: "/src/assets/experience/vlu_tn.jpg"}
    // ]
    ...
    const filtered = useMemo(
        () => (selected ? timeline.filter((t) => t.type === selected) : timeline),
        [selected, timeline]
    );
    ...
    return (
        <div id="section-experience" className={styles.container}>
            ...
            <div style={iconContainer}>
                ...
                >
                    <svg style={{ paddingTop: "4px" }} xmlns="http://www.w3.org/2000/svg" fill="currentColor" width={iconW} height={iconH} viewBox="0 0 465.185 465.185">
                        <g>
                            <g>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width={iconW} height={iconH} viewBox="0 0 489.205 489.205">
                        <g>
                            <g>
